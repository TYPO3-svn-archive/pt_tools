...
class tx_pttools_paymentRequestInformation implements tx_pttools_iSettableByArray  {
    ...
    /**
     * @var     string	(optional) reference number
     */
    ...
    public function __construct(array $dataArray=array(), $setDataFromSession=false) {
        ...
        if (!empty($dataArray)) {
            ...
            tx_pttools_sessionStorageAdapter::getInstance()->delete(self::SESSION_KEY_NAME_PAYMENT_REQUEST);
        }
     ...
     *
     * @param   void
     * @return  string       property value: billing address object of the ordering user
     * @since   2009-07-29
     ...
     * Sets the property value
     *
     * @param   string       property value: reference number
     * @return  void
     * @since   2009-07-29
     * @author 	Fabrizio Branca <fabrizio.branca@aoemedia.de>
     */
