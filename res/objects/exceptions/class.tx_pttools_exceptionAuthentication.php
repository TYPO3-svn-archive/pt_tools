 ...
 */ 
class tx_pttools_exceptionAuthentication extends tx_pttools_exception {
    ...
    public function __construct($errMsg='', $debugMsg='') {
        ...
        parent::__construct($errMsg, 4, $debugMsg);
 ...
 ******************************************************************************/
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pt_tools/res/objects/exceptions/class.tx_pttools_exceptionAuthentication.php']) {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pt_tools/res/objects/exceptions/class.tx_pttools_exceptionAuthentication.php']);
}
